...
some disj r1, r2, r3 : Read | some w : Write  | some br : Branch | 
  ...
  and (br->r1 in tfo) and (r1->w in tfo) and (r2->r3 in tfo) and (r2->r3 in po)
  and (r1->w in addr) and (r2 ->w in erfx)  and (w->r3 in erfx) and (r2->w in ecox) and (w->r3 in ecox) and (r2->r3 in ecox)
  and (r2->w in efrx) and (w->r3 in efrx) and (r2->r3 in efrx)
  and (r2->r3 in rf_init)
}
