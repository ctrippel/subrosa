...
// Spectre v1
//NOTE: There is an additional efrx loop that is not shown in the paper that would be ruled out in most consistency predicates.
...
some cf : CacheFlush | some r1 : Read | some r2 : Read | some r3 : Read | some br : Event  |
  a0 != a1 and s0 != s1 and s1 != s2 and s0 != s2 and br != cf and br != r1 and br != r2 and br != r3 and r1 != r2 and r1 != r3 and r2 != r3 and
